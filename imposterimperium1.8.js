...
const generalWords = [
  ...
  { word: "Luft", spy: "Wind", tip: "unsichtbar" },
  { word: "Glück", spy: "Zufall", tip: "selten" },
  { word: "Pech", spy: "Pechvogel", tip: "nervig" },
  { word: "Licht", spy: "Lampe", tip: "hell" },
  { word: "Dunkelheit", spy: "Schatten", tip: "nachts" },
  { word: "Staub", spy: "Sand", tip: "trocken" },
  { word: "Sand", spy: "Staub", tip: "Sommer" },
  { word: "Stein", spy: "Baum", tip: "hart" },
  { word: "Holz", spy: "Baum", tip: "Haus" },
  { word: "Baum", spy: "Wald", tip: "Blatt" },

  { word: "Wald", spy: "Biotop", tip: "Biologie" },
  { word: "Berg", spy: "Hügel", tip: "hoch" },
  { word: "Tal", spy: "Berg", tip: "tief" },
  { word: "Insel", spy: "Strand", tip: "allein" },
  { word: "Strand", spy: "Meer", tip: "sandig" },
  { word: "Meer", spy: "Ozean", tip: "windig" },
  { word: "Fluss", spy: "See", tip: "Strömung" },
  { word: "See", spy: "Teich", tip: "ruhig" },
  { word: "Brücke", spy: "Straße", tip: "verbinden" },
  { word: "Tunnel", spy: "Brücke", tip: "dunkel" },

  { word: "Seife", spy: "Shampoo", tip: "schaumig" },
  { word: "Shampoo", spy: "Seife", tip: "Haare" },
  { word: "Handtuch", spy: "Föhn", tip: "trocken" },
  { word: "Zahnbürste", spy: "Zahnpasta", tip: "morgens" },
  { word: "Zahnpasta", spy: "Zahnbürste", tip: "Minze" },
  { word: "Kleidung", spy: "Schrank", tip: "anziehen" },
  { word: "Schuhe", spy: "Socken", tip: "laufen" },
  { word: "Socken", spy: "Schuhe", tip: "Paar" },
  { word: "Jacke", spy: "Mantel", tip: "draußen" },
  { word: "Mütze", spy: "Cap", tip: "Kopf" },

  { word: "Brief", spy: "Paket", tip: "DHL" },
  { word: "Paket", spy: "Brief", tip: "senden" },
  { word: "Kalender", spy: "Uhr", tip: "Datum" },
  { word: "Uhr", spy: "Zeit", tip: "Umstellung" },
  { word: "Wecker", spy: "Uhr", tip: "morgens" },
  { word: "Bleistift", spy: "Stift", tip: "Blatt" },
  { word: "Radiergummi", spy: "Bleistift", tip: "Fehler" },
  { word: "Papier", spy: "Buch", tip: "weiß" },
  { word: "Karton", spy: "Paket", tip: "braun" },
  { word: "Sticker", spy: "Bild", tip: "klebt" }
];
...
const minecraftWords = [
  { word: "Creeper", spy: "Zombie", tip: "explosion" },
  { word: "Zombie", spy: "Baby Zombie", tip: "night" },
  { word: "Skeleton", spy: "Zombie", tip: "bow" },
  { word: "Enderman", spy: "End", tip: "teleport" },
  { word: "Villager", spy: "Iron Golem", tip: "trade" },
  { word: "Iron Golem", spy: "Villager", tip: "protector" },
  { word: "Wolf", spy: "Dog", tip: "tame" },
  { word: "Cat", spy: "Ocelot", tip: "sneak" },
  { word: "Horse", spy: "Donkey", tip: "ride" },
  { word: "Donkey", spy: "Horse", tip: "chest" },

  { word: "Diamond", spy: "lapis", tip: "blue" },
  { word: "Iron", spy: "Gold", tip: "armor" },
  { word: "Gold", spy: "Iron", tip: "armor" },
  { word: "Redstone", spy: "Lever", tip: "mechanic" },
  { word: "Coal", spy: "Torch", tip: "fuel" },
  { word: "Emerald", spy: "Diamond", tip: "trade" },
  { word: "Netherite", spy: "Diamond", tip: "strongest" },
  { word: "Obsidian", spy: "Bedrock", tip: "block" },
  { word: "Bedrock", spy: "Obsidian", tip: "deep" },
  { word: "Wood Pickaxe", spy: "Stone Pickaxe", tip: "start" },

  { word: "Crafting Table", spy: "Furnace", tip: "wood" },
  { word: "Furnace", spy: "Crafting Table", tip: "stone" },
  { word: "Anvil", spy: "Grindstone", tip: "strong" },
  { word: "Grindstone", spy: "Anvil", tip: "remove" },
  { word: "Enchanting Table", spy: "Bookshelf", tip: "paper" },
  { word: "Bookshelf", spy: "Book", tip: "paper" },
  { word: "Chest", spy: "Barrel", tip: "wood" },
  { word: "Barrel", spy: "Chest", tip: "wood" },
  { word: "Bed", spy: "Spawnpoint", tip: "villager" },
  { word: "Torch", spy: "Lantern", tip: "night" },

  { word: "Lantern", spy: "Torch", tip: "decoration" },
  { word: "Lever", spy: "Button", tip: "click" },
  { word: "Button", spy: "Lever", tip: "short" },
  { word: "Pressure Plate", spy: "Tripwire", tip: "dangerous" },
  { word: "Piston", spy: "Sticky Piston", tip: "push" },
  { word: "Sticky Piston", spy: "Piston", tip: "redstone" },
  { word: "Hopper", spy: "Dropper", tip: "transport" },
  { word: "Dropper", spy: "Dispenser", tip: "item" },
  { word: "Dispenser", spy: "Dropper", tip: "weapon" },
  { word: "Map", spy: "Compass", tip: "adventure" },

  { word: "Compass", spy: "Map", tip: "adventure" },
  { word: "Portal", spy: "Nether", tip: "water" },
  { word: "Nether", spy: "End", tip: "dangerous" },
  { word: "End", spy: "Nether", tip: "dangerous" },
  { word: "Ender Dragon", spy: "Wither", tip: "dangerous" },
  { word: "Wither", spy: "Ender Dragon", tip: "rare" },
  { word: "Brewing Stand", spy: "Potion", tip: "command" },
  { word: "Potion", spy: "Brewing Stand", tip: "kein Tipp :(" },
  { word: "Totem of Undying", spy: "Golden Apple", tip: "strong" },
  { word: "Golden Apple", spy: "Totem of Undying", tip: "heart" }
];
...
function isSpyAllowedByCategories() {
  return selectedCategories.every(c => categoryConfig[c]?.spy !== false);
}
...
function confirmCategories(){
  ...
  for (const c of selectedCategories){
    ...
    if (c === "minecraft") words = words.concat(minecraftWords);
  }
